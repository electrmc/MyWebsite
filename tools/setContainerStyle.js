	...
	function setNavbar(){
		...
		navImage.src = "http://www.mczone.com.cn/image/title.jpg";//js文件是html文件的路径，而非此js文件所在的路径
		// 本地图片地址：http://localhost/MyWebsite/image/title.jpg  
		// 服务器图片地址：http://www.mczone.com.cn/image/title.jpg
		navImage.onerror = function(){navImage.src = "http://www.mczone.com.cn/image/title.jpg"};
